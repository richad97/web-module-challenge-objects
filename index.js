...
reviews[6].feedback =
  'this place is chill with really cool people, great for getting work done on weekday';
console.log(reviews);
...
function getLastReview(arr) {
  let lastArrObj = arr.pop();

  return `${lastArrObj.name} gave the restaurant a ${lastArrObj.rating} star review, and their feedback was: ${lastArrObj.feedback}`;
}
